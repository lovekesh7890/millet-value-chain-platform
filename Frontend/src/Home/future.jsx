      ...
      <div className="container-fluid p-0 bg-olive-100 mt-20 h-[450px]">
        <div className="row">
          <div className="col-6 p-5 mt-5">
            <h2 className="m-4 font-serif">The Superfood of the Future</h2>
            <p className="text-green-900 font-roboto">
            ...
            <ul className="font-roboto">
              <li className="mb-2 text-green-900">
                <i className="fa-solid fa-leaf"></i> Eco-friendly: Minimal
                water, fertilizer, and pesticides needed
              </li>
              <li className="mb-2 text-green-900">
